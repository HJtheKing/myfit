package com.chj.myfit.model.dto;

public class SearchConditionTemp {
	...
	public SearchConditionTemp() {
	}

	public SearchConditionTemp(String key, String word) {
		this(key, word, "none");
	}

	public SearchConditionTemp(String key, String word, String orderBy) {
		this(key, word, orderBy, "asc");
	}

	public SearchConditionTemp(String key, String word, String orderBy, String orderByDir) {
		this(key, word, orderBy, orderByDir, 1);
	}

	public SearchConditionTemp(String key, String word, String orderBy, String orderByDir, int currentPage) {
		this.key = key;
		this.word = word;
